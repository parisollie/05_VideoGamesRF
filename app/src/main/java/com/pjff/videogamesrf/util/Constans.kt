...
//Paso 1.7, para estarme conectando
object Constants{
    ...
    //Paso 1.8, a la web que me estare conectando.
    const val BASE_URL: String = "https://private-3dc8e0-xmen.apiary-mock.com/"
    //Para ir analizando los datos del servidor."LOGS" con esa palabra lo filtraremos
